...
{
/**
 * Total elements that will be paginated _total_items total
 *
 * @var int
 */
	 ...
	 *
	 * @param   int     $items_per_page  if not param passed the config.defines.php value will be used
	 * @param   string  $format          if not param passed value will be
	 *
	 * @return string
	 */
	public function getPaginator( $items_per_page = ITEMS_PER_PAGE, $format = 'HTML' )
	{
	 ...
	 * @param   int  $previous_page  if not param passed the config.defines.php value will be used
	 * @param   int  $next_page      if not param passed the config.defines.php value will be used
	 * @param   int  $total_page     if not param passed the config.defines.php value will be used
	 *
	 * @return string
	 */
	private function buildJSONPaginator($actual_page, $previous_page, $next_page, $total_page)
	{
		$paginator = array();
	 ...
	 * @return string
	 */
	private function buildHTMLPaginator( $actual_page, $previous_page, $next_page, $total_page )
	{
		$paginator = '';
	 ...
	 * @param   int  $last_page    to be pinage
	 *
	 * @return int|boolean returns false in case is the last page
	 */
	private function getNextPage( $actual_page , $last_page )
	{
	 ...
	 *
	 * @param   int  $total_items     to be pinage
	 * @param   int  $items_per_page  to be pinage
	 *
	 * @return int|boolean returns false in case is the last page
	 */
	private function getTotalPages( $total_items , $items_per_page )
	{
